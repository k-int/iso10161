...
public class SupplementalClientInfo_codec extends base_codec
{
  private static Log log = LogFactory.getLog(SupplementalClientInfo_codec.class);
  public static SupplementalClientInfo_codec me = null;

  private ClientInfoData_codec i_clientinfodata_codec = ClientInfoData_codec.getCodec();

  public synchronized static SupplementalClientInfo_codec getCodec()
  {
    if ( me == null )
    {
      me = new SupplementalClientInfo_codec();
    }
    return me;
  }
                          ...
                          String type_name) throws java.io.IOException
  {
         ...
         ( sm.getDirection() == SerializationManager.DIRECTION_DECODE ) )
    {
      if ( sm.sequenceBegin() )
      {
        ...
        retval = sm.sequenceOf(retval, i_clientinfodata_codec);
