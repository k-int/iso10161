...
public class recipient_info_inline43_codec extends base_codec
{
  private static Log log = LogFactory.getLog(recipient_info_inline43_codec.class);
  public static recipient_info_inline43_codec me = null;

  private APDU_Delivery_Parameters_codec i_apdu_delivery_parameters_codec = APDU_Delivery_Parameters_codec.getCodec();

  public synchronized static recipient_info_inline43_codec getCodec()
  {
    if ( me == null )
    {
      me = new recipient_info_inline43_codec();
    }
    return me;
  }
