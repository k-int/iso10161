...
public class transponder_info_inline44_codec extends base_codec
{
  private static Log log = LogFactory.getLog(transponder_info_inline44_codec.class);
  public static transponder_info_inline44_codec me = null;

  private APDU_Delivery_Parameters_codec i_apdu_delivery_parameters_codec = APDU_Delivery_Parameters_codec.getCodec();

  public synchronized static transponder_info_inline44_codec getCodec()
  {
    if ( me == null )
    {
      me = new transponder_info_inline44_codec();
    }
    return me;
  }
