...
public class ReasonInReview_codec extends base_codec
{
  private static Log log = LogFactory.getLog(ReasonInReview_codec.class);
  public static ReasonInReview_codec me = null;

  private Enumerated_codec i_enumerated_codec = Enumerated_codec.getCodec();

  public synchronized static ReasonInReview_codec getCodec()
  {
    if ( me == null )
    {
      me = new ReasonInReview_codec();
    }
    return me;
  }
