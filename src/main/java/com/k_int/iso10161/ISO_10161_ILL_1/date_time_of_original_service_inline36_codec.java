...
public class date_time_of_original_service_inline36_codec extends base_codec
{
  ...
  public synchronized static date_time_of_original_service_inline36_codec getCodec()
  {
    if ( me == null )
    {
      me = new date_time_of_original_service_inline36_codec();
    }
    return me;
  }
 ...
 */  
  ...
  {
    date_time_of_original_service_inline36_type retval = (date_time_of_original_service_inline36_type)type_instance;
    ...
    if ( sm.sequenceBegin() )
    {
      ...
      {
          retval = new date_time_of_original_service_inline36_type();
      }
