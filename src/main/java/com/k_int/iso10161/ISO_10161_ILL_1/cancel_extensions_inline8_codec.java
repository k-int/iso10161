...
public class cancel_extensions_inline8_codec extends base_codec
{
  private static Log log = LogFactory.getLog(cancel_extensions_inline8_codec.class);
  public static cancel_extensions_inline8_codec me = null;

  private Extension_codec i_extension_codec = Extension_codec.getCodec();

  public synchronized static cancel_extensions_inline8_codec getCodec()
  {
    if ( me == null )
    {
      me = new cancel_extensions_inline8_codec();
    }
    return me;
  }
