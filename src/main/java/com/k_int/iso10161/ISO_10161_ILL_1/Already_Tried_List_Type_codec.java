...
public class Already_Tried_List_Type_codec extends base_codec
{
  private static Log log = LogFactory.getLog(Already_Tried_List_Type_codec.class);
  public static Already_Tried_List_Type_codec me = null;

  private System_Id_codec i_system_id_codec = System_Id_codec.getCodec();

  public synchronized static Already_Tried_List_Type_codec getCodec()
  {
    if ( me == null )
    {
      me = new Already_Tried_List_Type_codec();
    }
    return me;
  }
