...
public class Received_codec extends base_codec
{
 ...
 */  
  ...
  {
    Received_type retval = (Received_type)type_instance;

    if ( sm.constructedBegin(64, 8) )
    {
      sm.sequenceBegin();

      if ( sm.getDirection() == SerializationManager.DIRECTION_DECODE )
      {
          retval = new Received_type();
      }
      ...
      retval.date_received = (java.lang.String)sm.implicit_tag(i_iso_date_codec, retval.date_received, 128, 36, false, "date_received");
      ...
      retval.received_extensions = (java.util.Vector)sm.implicit_tag(i_received_extensions_inline10_codec, retval.received_extensions, 128, 49, true, "received_extensions");
      sm.constructedEnd();
      sm.sequenceEnd();
    }
