...
public class recall_extensions_inline11_codec extends base_codec
{
  private static Log log = LogFactory.getLog(recall_extensions_inline11_codec.class);
  public static recall_extensions_inline11_codec me = null;

  private Extension_codec i_extension_codec = Extension_codec.getCodec();

  public synchronized static recall_extensions_inline11_codec getCodec()
  {
    if ( me == null )
    {
      me = new recall_extensions_inline11_codec();
    }
    return me;
  }
