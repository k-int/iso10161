...
public class locations_inline33_codec extends base_codec
{
  private static Log log = LogFactory.getLog(locations_inline33_codec.class);
  public static locations_inline33_codec me = null;

  private Location_Info_codec i_location_info_codec = Location_Info_codec.getCodec();

  public synchronized static locations_inline33_codec getCodec()
  {
    if ( me == null )
    {
      me = new locations_inline33_codec();
    }
    return me;
  }
