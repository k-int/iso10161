...
public class locations_inline39_codec extends base_codec
{
  private static Log log = LogFactory.getLog(locations_inline39_codec.class);
  public static locations_inline39_codec me = null;

  private Location_Info_codec i_location_info_codec = Location_Info_codec.getCodec();

  public synchronized static locations_inline39_codec getCodec()
  {
    if ( me == null )
    {
      me = new locations_inline39_codec();
    }
    return me;
  }
