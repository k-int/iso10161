...
public class lost_extensions_inline17_codec extends base_codec
{
  private static Log log = LogFactory.getLog(lost_extensions_inline17_codec.class);
  public static lost_extensions_inline17_codec me = null;

  private Extension_codec i_extension_codec = Extension_codec.getCodec();

  public synchronized static lost_extensions_inline17_codec getCodec()
  {
    if ( me == null )
    {
      me = new lost_extensions_inline17_codec();
    }
    return me;
  }
