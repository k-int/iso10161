...
/** A Java holder for the ASN type : Renew_type 
 *  @author Auto generated bu A2J
 */ 
public class Renew_type implements Serializable 
{
    /** Mandatory member */
    ...
    /** Optional member */
    public java.lang.String desired_due_date = null;
    /** Optional member */
    public ILL_String_type requester_note = null;
    /** Optional member */
    public java.util.Vector renew_extensions = null;


    public Renew_type(BigInteger protocol_version_num,
      Transaction_Id_type transaction_id,
      Service_Date_Time_type service_date_time,
      System_Id_type requester_id,
      System_Id_type responder_id,
      java.lang.String desired_due_date,
      ILL_String_type requester_note,
      java.util.Vector renew_extensions)
    {
        ...
        this.renew_extensions=renew_extensions;
    }
    ...
    public String toString()
    {
        ...
        sw.write("desired_due_date="+desired_due_date);
        sw.write("requester_note="+requester_note);
        sw.write("renew_extensions="+renew_extensions);
        sw.write("\n}\n");
        return sw.toString();
    }
