...
public class Conditional_Reply_codec extends base_codec
{
  private static Log log = LogFactory.getLog(Conditional_Reply_codec.class);
  public static Conditional_Reply_codec me = null;
  ...
  private conditional_reply_extensions_inline7_codec i_conditional_reply_extensions_inline7_codec = conditional_reply_extensions_inline7_codec.getCodec();
  ...
  public synchronized static Conditional_Reply_codec getCodec()
  {
    if ( me == null )
    {
      me = new Conditional_Reply_codec();
    }
    return me;
  }
 ...
 */  
  ...
  {
    Conditional_Reply_type retval = (Conditional_Reply_type)type_instance;

    if ( sm.constructedBegin(64, 5) )
    {
      sm.sequenceBegin();

      if ( sm.getDirection() == SerializationManager.DIRECTION_DECODE )
      {
          retval = new Conditional_Reply_type();
      }
      ...
      retval.conditional_reply_extensions = (java.util.Vector)sm.implicit_tag(i_conditional_reply_extensions_inline7_codec, retval.conditional_reply_extensions, 128, 49, true, "conditional_reply_extensions");
      sm.constructedEnd();
      sm.sequenceEnd();
    }
