...
public class overdue_extensions_inline14_codec extends base_codec
{
  private static Log log = LogFactory.getLog(overdue_extensions_inline14_codec.class);
  public static overdue_extensions_inline14_codec me = null;

  private Extension_codec i_extension_codec = Extension_codec.getCodec();

  public synchronized static overdue_extensions_inline14_codec getCodec()
  {
    if ( me == null )
    {
      me = new overdue_extensions_inline14_codec();
    }
    return me;
  }
