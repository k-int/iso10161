...
public class message_extensions_inline19_codec extends base_codec
{
  private static Log log = LogFactory.getLog(message_extensions_inline19_codec.class);
  public static message_extensions_inline19_codec me = null;

  private Extension_codec i_extension_codec = Extension_codec.getCodec();

  public synchronized static message_extensions_inline19_codec getCodec()
  {
    if ( me == null )
    {
      me = new message_extensions_inline19_codec();
    }
    return me;
  }
