...
public class Status_Query_codec extends base_codec
{
  private static Log log = LogFactory.getLog(Status_Query_codec.class);
  public static Status_Query_codec me = null;

  private System_Id_codec i_system_id_codec = System_Id_codec.getCodec();
  private status_query_extensions_inline20_codec i_status_query_extensions_inline20_codec = status_query_extensions_inline20_codec.getCodec();
  ...
  public synchronized static Status_Query_codec getCodec()
  {
    if ( me == null )
    {
      me = new Status_Query_codec();
    }
    return me;
  }
 ...
 */  
  ...
  {
    Status_Query_type retval = (Status_Query_type)type_instance;

    if ( sm.constructedBegin(64, 18) )
    {
      sm.sequenceBegin();

      if ( sm.getDirection() == SerializationManager.DIRECTION_DECODE )
      {
          retval = new Status_Query_type();
      }
      ...
      retval.status_query_extensions = (java.util.Vector)sm.implicit_tag(i_status_query_extensions_inline20_codec, retval.status_query_extensions, 128, 49, true, "status_query_extensions");
      sm.constructedEnd();
      sm.sequenceEnd();
    }
